// ---------- PRODUCT DATA ----------
  const products = [
    ...
    { id:2, name:'URBAN TREK PRO', price:6499, tag:'New', img:'https://images.unsplash.com/photo-1520639889313-7272175b1c39?auto=format&fit=crop&q=80&w=800', sizes:[6,7,8,9], collection:'terra', category:'Boots', color:'Brown' },
    ...
    { id:8, name:'METRO WALKER', price:7499, tag:'New', img:'https://images.unsplash.com/photo-1524532700868-fb53982e5163?auto=format&fit=crop&q=80&w=800', sizes:[8,9,10], collection:'street', category:'Sneakers', color:'Black' },
    ...
    { id:15, name:'DESERT STORM', price:7299, tag:'New', img:'https://images.unsplash.com/photo-1520639889313-7272175b1c39?auto=format&fit=crop&q=80&w=800', sizes:[8,9,10], collection:'terra', category:'Boots', color:'Brown' },
    ...
    { id:19, name:'URBAN FLOW', price:6299, tag:'New', img:'https://images.unsplash.com/photo-1524532700868-fb53982e5163?auto=format&fit=crop&q=80&w=800', sizes:[7,8,9,10], collection:'street', category:'Sneakers', color:'Black' },
    ...
    { id:25, name:'CITY PULSE', price:6999, tag:'Hot', img:'https://images.unsplash.com/photo-1524532700868-fb53982e5163?auto=format&fit=crop&q=80&w=800', sizes:[7,8,9,10], collection:'street', category:'Sneakers', color:'Black' },
    ...
    { id:32, name:'RUGGED EDGE', price:8299, tag:'New', img:'https://images.unsplash.com/photo-1520639889313-7272175b1c39?auto=format&fit=crop&q=80&w=800', sizes:[8,9,10,11], collection:'terra', category:'Boots', color:'Brown' },
    ...
    { id:36, name:'URBAN EDGE', price:6899, tag:'', img:'https://images.unsplash.com/photo-1524532700868-fb53982e5163?auto=format&fit=crop&q=80&w=800', sizes:[7,8,9,10], collection:'street', category:'Sneakers', color:'Black' },
